...
class _HomePageState extends State<HomePage> {
  ...
  Future getBunkData() async {
    QuerySnapshot qn =
        await Firestore.instance.collection("updatebunkrecords").getDocuments();
    return qn.documents;
  }
              ...
              child: FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      subject_one.text =
                          snapshot.data[index].data["subject #1"].toString();
                      subject_two.text =
                          snapshot.data[index].data["subject #2"].toString();
                      subject_three.text =
                          snapshot.data[index].data["subject #3"].toString();
                      subject_four.text =
                          snapshot.data[index].data["subject #4"].toString();
                      subject_five.text =
                          snapshot.data[index].data["subject #5"].toString();

                      bunked_one_controller.text =
                          snapshot.data[index].data["bunked_one"].toString();
                      bunked_two_controller.text =
                          snapshot.data[index].data["bunked_two"].toString();
                      bunked_three_controller.text =
                          snapshot.data[index].data["bunked_three"].toString();
                      bunked_four_controller.text =
                          snapshot.data[index].data["bunked_four"].toString();
                      bunked_five_controller.text =
                          snapshot.data[index].data["bunked_five"].toString();
                      return Column(
                        children: <Widget>[
                          BunkChart(
                              data: (index == 0)
                            ...
                            child: RawMaterialButton(
                              ...
                              onPressed: () {
                                Firestore.instance
                                  ...
                                  "bunked_one":
                                      int.parse(bunked_one_controller.text),
                                  "bunked_two":
                                      int.parse(bunked_two_controller.text),
                                  "bunked_three":
                                      int.parse(bunked_three_controller.text),
                                  "bunked_four":
                                      int.parse(bunked_four_controller.text),
                                  "bunked_five":
                                      int.parse(bunked_five_controller.text)
                                });
                                setState(() {});
                              },
                              child: Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Text(
                                  "Update data for semester ${index + 3}",
                                  style: TextStyle(
                                    fontSize: 20.0,
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Stack(
                          children: <Widget>[
                            Container(child: BunkChart(data: data)),
                            Row(
                              children: <Widget>[
                                SizedBox(
                                  width: 310.0,
                        ...
                        Stack(
                          children: <Widget>[
                            Container(child: BunkChart(data: data6)),
                            Row(
                              children: <Widget>[
                                SizedBox(
                                  width: 310.0,
