...
if (isset($_POST['insert_user'])) {
  ...
  $healthscore=100+(-0.1*$colestrol-0.1*$sugar+0.4*$st+0.4*$et);
  	...
  	$query = "INSERT INTO healthdata (username, age, weight, colestrol, sugar, hemo, height, st, et, hs)
  			  VALUES('$username', '$age', '$weight', '$colestrol', '$sugar', '$hemo', '$height', '$st', '$et', '$healthscore')";
